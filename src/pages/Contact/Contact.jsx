...
const Contact = () => {
  ...
  return (
    <div className='w-full h-[100vh] flex justify-between p-4 lg:p-12 bg-[#EA580C]'>
       <div>
      ...
      <div className='flex flex-col justify-between h-full'>
        {/* left--top */}
        <div>
          <h4 className='text-4xl font-semibold text-white mb-2'>Contact support</h4>
      ...
      {/* Right */}
      <div className="bg-white px-8 w-[30rem] rounded-[12px]">
        <form className="flex flex-col relative">
          ...
          <div className='flex justify-center items-center absolute right-[-3.5rem] bottom-0 w-[4rem] h-[4rem] bg-white shadow-lg rounded-full'>
